...
<body>
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-dark text-white text-center" style:"font-size:38px; "><b>Registration</b></div>
        ...
        <p style="margin-left:230px;">Already have an account? <a href="{{ route('loginform') }}">Login here</a></p>
